                        ...
                        <div className="relative z-10 flex h-full items-center">
                            <div className="container mx-auto px-4">
                                <div className="max-w-2xl md:ml-8">
                                    ...
                                    <Button size="lg" className="bg-primary hover:bg-primary/90 rounded-md px-6 md:px-8 py-4 md:py-6 text-base md:text-lg animate-fade-in-up animation-delay-200">
