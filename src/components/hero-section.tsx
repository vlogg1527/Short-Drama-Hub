    ...
    <>
      ...
      <div className="md:hidden relative w-full text-white">
          <div className="relative h-[80vh] min-h-[550px] w-full">
              <Image
                  src={firstDrama.coverArt.replace('300x450', '800x1200')}
                  alt={`Background for ${firstDrama.title}`}
                  fill
                  className="object-cover object-top"
                  data-ai-hint={firstDrama.dataAiHint}
                  priority
              />
              <div className="absolute inset-0 bg-gradient-to-t from-background via-black/30 to-transparent" />
              
              <div className="absolute z-10 flex h-full items-end pb-24 w-full">
                  <div className="container mx-auto px-4 text-center w-full">
                      <div className="flex flex-col items-center">
                          ...
                          <div className="flex items-center gap-2 mb-4">
                              <p className="font-semibold text-sm">เมื่อบุปผาร่วงโรย</p>
